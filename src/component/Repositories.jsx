    ...
    return (
        <div>
            ...
            <div className='container mx-auto flex flex-wrap justify-evenly items-center m-5 relative z-50'>
                ...
                <Link to="https://poke-api-delta-blue.vercel.app/" className='py-4'>
                ...
                <Link to="https://ddc-electricts.vercel.app/" className='py-4'>
                    <div className="max-w-md mx-auto bg-white rounded-xl overflow-hidden md:max-w-2xl">
                        <img className="w-full h-32 md:h-48 object-cover object-center" src="https://www.enelx.com/content/dam/local-colombia/articulos-personas/banners/2022/07/sistema-fotovoltaico--conoce-c%C3%B3mo-tu-empresa-puede-reducir-el-impacto-ambiental/sistema-solar-fotovoltaico-desktop.jpg" alt="Imagen de la tarjeta" />
                        <div className="p-6">
                            <h2 className="font-semibold text-xl mb-2">Enterprise of Energy DDC</h2>
                            <p className="text-gray-600">At DDc, we are dedicated to revolutionizing the renewable energy landscape by delivering cutting-edge solar energy solutions. Our mission is to harness the power of innovation and advanced technology to provide sustainable, efficient, and affordable energy for a cleaner future. </p>
                        </div>
                        <h2 className="font-semibold text-xl mb-2 px-6 pb-3">🛠 Language and tools</h2>
                        <div className="px-6 pb-3 flex justify-start items-start">
                            <FaReact className='size-12 mx-6' /><SiAxios className='size-12 mx-6' /><SiTailwindcss className='size-12 mx-6' /><SiVite className='size-12 mx-6' /><DiMaterializecss className='size-12 mx-6' />
